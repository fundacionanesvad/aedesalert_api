...
public class AreaCreateUpdateImpl implements Area{
	...
	public AreaCreateUpdateImpl(){}
	
	public AreaCreateUpdateImpl(String code, String name, Integer houses, String coords, Integer parentId, Integer typeId, BigDecimal latitude, BigDecimal longitude){		
		mCode      = code;
		mName      = name;
		mHouses    = houses;
		mCoords    = coords;
