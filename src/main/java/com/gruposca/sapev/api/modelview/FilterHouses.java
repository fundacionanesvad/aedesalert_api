...
public class FilterHouses {
	...
	public FilterHouses(String code, String areaName, String streetName, String streetNumber, String sectorName, String eessName , String microrredName){
		mCode         = code;
		mAreaName     = areaName;
