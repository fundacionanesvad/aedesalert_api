...
public class InspectionBlock {
	...
	private Integer mReconversions;

	
	public InspectionBlock() {}
	
	public InspectionBlock(Integer id, String code, String name, Integer houses, String coords , Integer typeId, BigDecimal latitude, BigDecimal longitude, Integer parentId, Integer reconversions){		
		mId        = id;
		mCode      = code;
		mName      = name;
		mHouses    = houses;
	...
	public Integer getReconversions() {return mReconversions;}
	public void setReconversions(Integer mReconversions) {this.mReconversions = mReconversions;}
