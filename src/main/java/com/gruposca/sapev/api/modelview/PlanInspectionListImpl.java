...
public class PlanInspectionListImpl implements Plan{
	...
	public PlanInspectionListImpl(){}
	
	public PlanInspectionListImpl(Integer id, Integer size, Long date, Integer userId, Integer inspectionId, Integer stateId, List<PlanAreas> areas, Byte houseInterval, Byte houseIni){		
		mId           = id;
		mPlanSize     = size;
		mDate         = date;
		mUserId       = userId;
