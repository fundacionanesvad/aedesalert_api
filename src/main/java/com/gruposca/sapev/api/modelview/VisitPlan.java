...
public class VisitPlan {
	...
	public VisitPlan(String uuid, Long date, String resultName, Byte feverish){
		mUuid       = uuid;
		mDate       = date;
	...
	public VisitPlan(String uuid, Long date, String resultName, Byte feverish,Integer resultId){
		mUuid       = uuid;
		mDate       = date;
		mResultName = resultName;
		mFeverish   = feverish;
