...
public class UserCreateIml implements User{
	...
	public UserCreateIml(){};
	
	public UserCreateIml(String login, String password1, String password2, String name, String email, Boolean enabled, Integer profileId, Integer languageId, Integer areaId){		
		mLogin      = login;
