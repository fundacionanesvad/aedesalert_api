...
public class PlanVisitImpl implements Visit{
	...
	public PlanVisitImpl(){}
	
	public PlanVisitImpl(Integer areaName, String houseStreet, String houseNumber, Integer resultId, Integer personsNumber, BigInteger sample, BigDecimal dose, String uuid){
		mAreaName=			areaName;
	...
	public String getVisitUuid() {return mUuid;}
	public void setVisitUuid(String mUuid) {this.mUuid = mUuid;}
}
