...
public interface TableElementsDao extends BaseDao<TableElements, String>{
	...
	List<TableElements> getList(TableHeaders tableHeaders) throws Exception;
	
	List<Element> getList(Integer languageId) throws Exception;
