...
public interface FebrileDao extends BaseDao<Febriles, String>{

	FebrileList getListByAreaUser (Users user, ParamFilterFebriles paramFilterFebriles) throws Exception;	
