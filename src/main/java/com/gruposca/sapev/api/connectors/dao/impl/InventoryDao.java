...
public interface InventoryDao extends BaseDao<Inventories, String>{
	...
	public InspectorContainerData getInspectorContainerData(UUID visitsUuid) throws Exception;
